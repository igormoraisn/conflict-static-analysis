...
public class AffectedVariablesAnalysisConflictSinkTest {

    private AffectedVariablesFromSinkAnalysis analysis;
        ...
        PackManager.v().getPack("jtp").add(
                new Transform("jtp.oneConflict", new BodyTransformer() {
                    ...
                    protected void internalTransform(Body body, String phaseName, Map<String, String> options) {
                        analysis = new AffectedVariablesFromSinkAnalysis(body, definition);
                    }
                }));
    ...
    public void testAffectedVariablesAnalysisWithOutChanged() {
        ...
        List<String> variables = Arrays.asList("w", "c");
        Assert.assertEquals(variables, outChanged);
    }
    ...
    public void testAffectedVariablesAnalysisWithOutPropagated() {
        ...
        Assert.assertEquals(variables, outPropagated);
    }
}
